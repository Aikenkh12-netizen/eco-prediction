...
if sri < 30:
    st.success("Низкий SRI — экосистема устойчива, вода в хорошем состоянии.")
elif sri < 60:
    st.warning("Средний SRI — есть отклонения, возможны риски. Требуется мониторинг.")
else:
    st.error("Высокий SRI — экосистема под угрозой, параметры сильно отклонены от нормы. Необходимы меры по очистке и стабилизации.")
