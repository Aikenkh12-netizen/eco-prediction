...
if sri < 30:
    st.success("Низкий SRI (<30) — экосистема устойчива, вода в хорошем состоянии.")
elif sri < 60:
    st.warning("Средний SRI (30–60) — есть отклонения, возможны риски. Требуется мониторинг.")
else:
    st.error("Высокий SRI (>60) — экосистема под угрозой, параметры сильно отклонены от нормы. Необходимы меры по очистке и стабилизации.")
