...
if sri < 15:
    st.success("Норма (<15) — экосистема устойчива, вода в хорошем состоянии.")
elif sri < 25:
    st.warning("Риск (15–25) — есть отклонения, возможны проблемы. Требуется мониторинг.")
elif sri < 35:
    st.error("Высокий риск (25–35) — экосистема под угрозой, параметры значительно отклонены от нормы.")
else:
    st.error("Цветение (>35) — высокая вероятность бурного роста микроводорослей, необходимы срочные меры.")
